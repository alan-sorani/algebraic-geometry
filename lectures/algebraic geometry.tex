...
\[F^+\prs{U} = \set{s \colon U \to \coprod_{p \in U} F_p}{\substack{\forall p \in U \colon s\prs{p} \in F_p \\ \forall p \in U \exists p \in V \subseteq U \exists t \in F\prs{V} \forall Q \in V \colon t\prs{Q} = s\prs{Q} \in F_Q}} \text{.}\]
