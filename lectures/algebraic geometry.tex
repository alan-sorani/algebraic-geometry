...
To solve this use sheaf hom as defined in the exercises in Hartshorne.
It follows that $\prs{f, f^{\#}}$ agrees with the map on locally ringed spaces induced by $\phi \colon A \to B$.
\end{enumerate}
\end{proof}
